...
def complaint_admin_update(request, pk):
    ...
    old_status_display = complaint.get_status_display()  # type: ignore[attr-defined]
    ...
    create_status_notification(
        complaint, old_status_display, complaint.get_status_display()  # type: ignore[attr-defined]
    )
...
def complaint_update_status(request, pk):
    ...
    if new_status and new_status in valid_statuses:
        ...
        updates.append(f"durum: {complaint.get_status_display()}")  # type: ignore[attr-defined]
    ...
    if new_priority and new_priority in valid_priorities:
        ...
        updates.append(f"öncelik: {complaint.get_priority_display()}")  # type: ignore[attr-defined]
